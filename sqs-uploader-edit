!function(e, t) {
	...
	var s,
		...
		o = /.*[.]/,
		r = /[\t\r\n]/g,
		a = 0 < Object.prototype.toString.call(g.HTMLElement).indexOf("Constructor"),
		l = -1 !== navigator.userAgent.indexOf("MSIE 7"),
		u = document.createElement("input");
	u.type = "file",
	s = "multiple" in u && "undefined" != typeof File && void 0 !== (new XMLHttpRequest).upload,
	...
	y.addEvent = function(e, t, s) {
		"use strict";
		return e.addEventListener ? e.addEventListener(t, s, !1) : e.attachEvent("on" + t, s), function() {
			y.removeEvent(e, t, s)
		}
	},
	...
	y.getIFrame = function() {
		...
		var e,
			t = y.getUID();
		return l ? e = document.createElement('<iframe src="javascript:false;" name="' + t + '">') : ((e = document.createElement("iframe")).src = "javascript:false;", e.name = t), e.style.display = "none", e.id = t, e
	},
	...
	return y.indexOf = [].indexOf ? function(e, t) {
		...
		"use strict";
		return !!e && (1 !== e.nodeType || e == document.body ? !(e = null) : e.parentNode && (0 < e.offsetWidth || 0 < e.offsetHeight || "none" != y.getStyle(e, "display").toLowerCase()) ? y.isVisible(e.parentNode) : (e = null, !1))
	}, y.getStyle = function(e, t) {
		"use strict";
		return g.getComputedStyle ? e.ownerDocument.defaultView.getComputedStyle(e, null).getPropertyValue(t) : e.currentStyle && e.currentStyle[t] ? e.currentStyle[t] : void 0
		...
		"use strict";
		return !(!e || !t) && 0 <= (" " + e.className + " ").replace(r, " ").indexOf(" " + t + " ")
		...
		setForm: function(e) {
			...
			this._form && "FORM" == this._form.nodeName.toUpperCase() ? ((t = this)._opts.autoSubmit = !1, this._opts.overrideSubmit && (y.addEvent(this._form, "submit", function(e) {
				...
				d._detachEvents[t.id] = y.addEvent(h, label, function() {
					if (h && h.parentNode && !m)
						if (d._detach(t.id), m = !0, delete d._progKeys[p], delete d._sizeFlags[p], r && y.removeEvent(r, "click", l), c.cors)
							...
							try {
								var e = (h.contentDocument ? h.contentDocument : h.contentWindow.document).body.innerHTML;
								y.remove(h),
								h = null,
		...
		_getProg: function(o, r, a, l, u) {
			...
			if (o)
				if (p.nginxProgressUrl ? e = p.nginxProgressUrl + "?" + encodeURIComponent(p.nginxProgressHeader) + "=" + encodeURIComponent(o) + "&_=" + t : p.sessionProgressUrl ? e = p.sessionProgressUrl : p.progressUrl && (e = p.progressUrl + "?progresskey=" + encodeURIComponent(o) + "&_=" + t), d = function() {
					...
					if (!g.XDomainRequest)
						return;
					(h = new g.XDomainRequest).open("GET", e, !0),
...
function() {
	function o(e) {
		var n;
		e && e.currentTarget && (n = e.currentTarget).onceAfter("rendered", function() {
			var e,
				t,
				s;
			!n.titleTextEl || "Add Form Field" !== n.titleTextEl.get("textContent") || "file" !== (t = (e = n.fields.fieldOptions).get("options"))[0].icon && (t.unshift({
				icon: "file",
				title: "Upload Files",
				value: {
			...
			"editor-block-form" === n.getName() && (s = n.getField("fields")).after("dataChange", function() {
				s.get("contentBox").all(".sqs-form-builder-field").each(function(e) {
					e.one('textarea[placeholder="Description"]') && -1 < e.one('textarea[placeholder="Description"]').get("innerText").indexOf("FileField;") && e.addClass("icon-file")
				})
			})
		})
	}
		...
		function t(e) {
			if (e.length)
				for (var t = 0; t < e.length; t++) {
					var s = function(e) {
						var s = [];
						return Array.prototype.slice.call(e.querySelectorAll(".form-item")).forEach(function(e) {
					...
					s.length && s.forEach(function(e, t) {
						!function(l) {
							if (l.className.indexOf("sqsf-uploader") < 0) {
								...
								l.querySelector(".description") && (l.querySelector(".description").style.display = "none");
								var t,
									s = l.querySelector(".description") ? l.querySelector(".description").textContent.replace(/ /g, "") : "",
									n = l.querySelector(".field-element"),
									i = n.getAttribute("placeholder") ? n.getAttribute("placeholder").replace(/ /g, "").split(",") : [".jpg", ".jpeg", ".png", ".gif", ".txt"];
								n && (n.style.display = "none"),
								n && "TEXTAREA" !== n.tagName && (n.style.display = "none", (t = document.createElement("textarea")).id = n.id, t.style.display = "none", t.className = n.className, t.value = n.value.replace(/   /g, "   \n"), l.removeChild(n), n = t, l.appendChild(n));
								var u,
									o,
									r = 1024,
									a = "Add_Files",
								...
								var v,
									...
									x = new ss.SimpleUpload({
										...
										onSubmit: function(e, t, s, n) {
											...
											r.className = "wrapper",
											u || Array.prototype.slice.call(l.querySelectorAll(".wrapper")).forEach(function(e) {
										...
										onComplete: function(e, t) {
											...
											var s;
											t.success ? (n.value = n.value + "   \n" + t.fileUrl, (s = document.createElement("div")).className = "upload-success", s.innerHTML = '<div class="name" style="margin:10px 10px 10px 0;color: green;">' + e + " <span> - " + (t.size / 1e3).toFixed(2) + "KB</span></div>", _.appendChild(s)) : (m.innerHTML = t.msg, l.insertBefore(m, l.querySelector(".title")), Array.prototype.slice.call(l.querySelectorAll(".wrapper")).forEach(function(e) {
												e.parentNode.removeChild(e)
								...
								n.value && -1 < n.value.indexOf("https://") && (v = n.value.trim().split("   \n").length, y = 1 < v ? "s" : "", (b = document.createElement("div")).className = "upload-success", b.innerHTML = '<div class="name" style="margin:10px 10px 10px 0;color: green;">' + v + " <span>file" + y + " already added.</span></div>", _.appendChild(b)),
								function(e) {
									try {
	...
	function s() {
		...
		s = "uploaderTopStyles",
		t.querySelector("#" + s) || ((i = document.createElement("link")).href = e, i.rel = "stylesheet", i.id = s || (new Date).getTime(), i.onload = function() {
			n && n(null, {
				nodes: [this]
			})
		}, (t = t || document.getElementsByTagName("head")[0]).appendChild(i)),
